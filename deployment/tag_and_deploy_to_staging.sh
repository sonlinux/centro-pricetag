...
then
    ...
    rsync -L  backups/latest.dmp staging.pricetag.companyx.com:/home/pricetag-client/deployment/backups/
    rsync -r -v media/ staging.pricetag.companyx.com:/home/pricetag-client/deployment/media
	...
	ssh staging.pricetag.companyx.com "cd /home/pricetag-client/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
